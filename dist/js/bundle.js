  ...
  computed: {
    filteredBands: function filteredBands() {
      ...
      return this.bands.filter(function (band) {
        return band.name.toLowerCase().includes(self.search) || band.genre && band.genre.toLowerCase().includes(self.search) || band.origin && band.origin.toLowerCase().includes(self.search);
      });
    }
  }
});
