...
Logos styles are written in [SASS](https://sass-lang.com) with `SCSS` syntax.
...
All JSON files will be merged into a single file generated by [Gulp](https://gulpjs.com) and stored in `server/db/data.json`.
